...
ActiveRecord::Schema.define(version: 2019_07_24_124456) do
  ...
  create_table 'components', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[ingredient_id], name: 'index_components_on_ingredient_id'
    t.index %w[recipe_id], name: 'index_components_on_recipe_id'
  end
  ...
  create_table 'steps', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[recipes_id], name: 'index_steps_on_recipes_id'
  end
