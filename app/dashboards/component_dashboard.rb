...
class ComponentDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = %i[recipe ingredient id type].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = %i[recipe ingredient id type quantity].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = %i[recipe ingredient type quantity].freeze
